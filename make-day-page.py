...
"""
 ...
 CERN@school: Making the MoEDAL LHC Run 1 Timepix data pages - days.
...
if __name__ == "__main__":
    ...
    print("*")
    print("*====================================================*")
    print("* CERN@school - make the HTML pages for day profiles *")
    print("*====================================================*")
    ...
    lg.basicConfig(filename=os.path.join(outputpath, 'log_make-day-page.log'), filemode='w', level=level)
